...
namespace Persistence.Repositories
{
    public class RepositoryManager(ExpensesManagementDatabaseContext dbContext) : IRepositoryManager
    {
        ...
        private readonly Lazy<ITransactionsRepository> lazyTransactionsRepository = new(() => new TransactionsRepository(dbContext));
        ...
        public ITransactionsRepository TransactionsRepository => lazyTransactionsRepository.Value;
    }
}
